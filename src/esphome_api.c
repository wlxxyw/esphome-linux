...
static const char* message_type_name(uint16_t msg_type) {
    switch (msg_type) {
        ...
        case ESPHOME_MSG_LIST_ENTITIES_SENSOR_RESPONSE: return "LIST_ENTITIES_SENSOR_RESPONSE";
        case ESPHOME_MSG_LIST_ENTITIES_SWITCH_RESPONSE: return "LIST_ENTITIES_SWITCH_RESPONSE";
        case ESPHOME_MSG_LIST_ENTITIES_DONE_RESPONSE: return "LIST_ENTITIES_DONE_RESPONSE";
        case ESPHOME_MSG_SENSOR_STATE_RESPONSE: return "SENSOR_STATE_RESPONSE";
        case ESPHOME_MSG_SWITCH_STATE_RESPONSE: return "SWITCH_STATE_RESPONSE";
        case ESPHOME_MSG_SWITCH_COMMAND_REQUEST: return "SWITCH_COMMAND_REQUEST";
